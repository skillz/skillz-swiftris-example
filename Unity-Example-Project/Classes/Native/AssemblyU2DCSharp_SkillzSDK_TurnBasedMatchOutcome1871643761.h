...
struct  TurnBasedMatchOutcome_t1871643761 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TurnBasedMatchOutcome_t1871643761, ___value___1)); }
